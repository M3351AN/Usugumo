...
global_asm!(
    ".text
.global KeyboardClassDequeueReadMeme
KeyboardClassDequeueReadMeme:
    xor edx, edx
    lea r8, [rcx+0xA8]
1:
...
.global KeyboardClassReadCopyDataMeme
KeyboardClassReadCopyDataMeme:
    mov r11, rsp
...
.global KeyboardClassServiceCallbackMeme
